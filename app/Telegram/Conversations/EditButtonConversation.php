...
class EditButtonConversation extends Conversation
{
    ...
    private function promptLabel(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(
            ...
            "💡 اگر ایموجی پریمیوم بخواهی، همان ایموجی را داخل متن بفرست؛ خودم پیدا و اعمالش می‌کنم.\n".
            "ℹ️ توجه: تلگرام ایموجی پریمیوم را همیشه «قبل از متن» (ابتدای دکمه) نشان می‌دهد؛ هرجای متن بگذاری، خودکار به ابتدای دکمه می‌رود.\n\n".
            'برای لغو: /cancel',
            parse_mode: 'HTML',
        );
