...
final class ContentDefaults
{
    ...
    public static function texts(): array
    {
        return [
            ...
            'config.menu_active' => "🎁 <b>اشتراک رایگان شما</b>\n\nشما یک اشتراک رایگان دارید. کانفیگ رایگانِ جدید داده نمی‌شود؛ پس از پایانِ زمان، می‌توانید همین را «تمدید» کنید یا وضعیتش را ببینید.",
            ...
            'config.free_not_expired' => '🎁 شما یک اشتراک رایگان دارید. کانفیگ رایگانِ جدید داده نمی‌شود؛ برای ادامه، پس از پایانِ زمان همین اشتراک را «تمدید» کنید.',
            ...
            'config.reprovision_notice' => "🔄 <b>سرور اشتراک شما به‌روزرسانی شد</b>\n\nبه دلیل تغییر سرور، <b>لینک اشتراک قبلی شما دیگر کار نمی‌کند</b>. لطفاً لینک قبلی را در برنامه‌ی خود حذف کنید و لینک جدیدِ زیر را وارد کنید. حجم و زمان اشتراک شما حفظ شده است.",
            ...
            'coin.pick_config' => "روی کدام اشتراک اعمال شود؟\n\n⚠️ توجه: فقط <b>حجمِ</b> بسته به اشتراک اضافه می‌شود؛ به <b>زمان</b> (تاریخ انقضا) چیزی اضافه نمی‌شود.",
